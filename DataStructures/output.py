...
def create_pure_tone(freq: float, duration: float, peak:int, fs: float = 44100, phase_shift=0)->AudioSignal:
...
def combine_signals(*sigs: AudioSignal, showFig=False) -> AudioSignal:
